...
class TestTextToNumDe(TestCase):
	...
	def test_all(self):
		...
		assert 100 == text2num("hundert")
		assert 179 == text2num("einhundertneunundsiebzig")
		assert 179 == text2num("hundertneunundsiebzig")
		assert 300 == text2num("dreihundert")
		assert 1200 == text2num("zwölfhundert")
		assert 12104 == text2num("zwölftausendhundertundvier")
